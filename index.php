  ...
  <div class="container">
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="content">
          <h3><span class="las la-star-of-life"></span> MATHQUIZEE</h3>
          <p>
            A fun game of Arithmetic Puzzles
          </p>
          <button class="btn transparent" id="sign-up-btn">Sign Up</button>
        </div>
        <img src="Images/—Pngtree—pencil compass compass calculator ruler_5368356.png" class="image" alt="" />
      </div>
      ...
      <div class="panel right-panel">
        <div class="content">
          <h3>Join the fun?</h3>
          <p>
            Access our game site by singing in with your credentials.
          </p>
