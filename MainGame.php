...
<!--Checks whether the use has signed in connecting to the database and creates a session from the server-end. -->
...
<!--Creating a Cookie on the client-side browser -->
  ...
  <link href="https://unpkg.com/tailwindcss@^1.0/dist/tailwind.min.css" rel="stylesheet" /> -->
    ...
    <script> 
        ...
        let handleInput = function(x) {
            ...
            // If Else Function to check whether the answer is correct > and trigger other functions.
             if (inp.value == solution) {
               ...
               // Here we trigger functions if the answer is wrong.
                ...
                if (Wscorevalue==5){ 
                    ...
                    // Here I have added a if else function to count the no of wrong answers and trigger other functions.
            ...
            // Here I have sed HTML DOM modifications to obtain OR target certain HTML elements and display Smile Game API question etc. 
...
<div>
    ...
    <!--  Here I have added buttons to obtain user inputs to the answer from 0-9 which triggers handleInput() function -->
    </div>
